...
r4 = client.get('/campaigns?tier=DRP%20IDs%20with%200%20Score')
print('4. Campaigns Status (0 Score):', r4.status_code)
...
assert r7.status_code == 200, f'API campaign job failed: {r7.status_code}'
